...
def parse_arguments():
    ...
    parser.add_argument('--pretrain_url', type=str, default='output/ckpt_0/', help='the training data')
    parser.add_argument('--data_url', type=str, default='mindcon_food_classification', help='the training data')
    parser.add_argument('--output_path', default='output', type=str, help='the path model saved')
    ...
    parser.add_argument("--swin_config", help="Config file to use (see configs dir)",
                        default='src/configs/msnet.yaml')
